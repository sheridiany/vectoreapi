...
export const STATIC_I18N_KEYS = [
  ...
  // Search product and AgentKeys
  'vSearch',
  'vSearch keys',
  'vSearch administration',
  'vSearch uses separate access keys and is billed separately from model API Keys.',
  'Discover vSearch capabilities from the same gate-relay account. vSearch keys are separate from model API Keys.',
  'Create vSearch key',
  'One vSearch entry, separate authorization',
  'Use a vSearch key for search capabilities. It cannot be used as a model API Key, and upstream provider secrets stay on the server.',
  'vSearch key required',
  'vSearch key management',
  'Create, copy, and revoke vSearch keys independently from model API Keys.',
  'Manage vSearch keys',
  'This local phase defines the vSearch product boundary. Key management is connected to gate-relay; search execution and cost aggregation are next.',
  'Loading…',
  'Failed to load vSearch keys',
  'No vSearch keys yet',
  'Revoke key',
  'Copy one-click install',
  'vSearch keys are separate from model API Keys. The same user and enterprise permissions still apply.',
  'Create a vSearch key',
  'Create a dedicated vSearch key for search access. This page will not show or modify model API Keys.',
  'Managed by gate-relay',
  'Key name',
  'e.g. research-bot…',
  ...
  'Generate a short-lived install command after creating a key. The command can be used once.',
  'Available vSearch capabilities',
  'Each key receives explicit capabilities. Upstream connector secrets remain an admin-only setting.',
  'vSearch access policy',
  'Manage vSearch keys, capability scopes, upstream connectors, quotas, and search-specific audit data.',
  ...
  'Total AgentKeys',
  'Across the managed enterprise',
  'Active AgentKeys',
  'Ready to authenticate requests',
  'Configured scopes',
  'Capability groups in use',
  'Revoked AgentKeys',
  'No longer accepted by the gateway',
  'Copy AgentKey secret',
  'AgentKey secret copied',
  '{{count}} selected',
  'Revoke AgentKey?',
  'Requests using this AgentKey will stop working immediately. This action cannot be undone.',
  'Revoking…',
  'Refresh',
  'Monitor gateway-wide calls, throughput, and quota consumption.',
  'Total calls',
  'Current RPM',
  'Current TPM',
  'Quota consumed',
  'Across all visible logs',
  'Call volume',
  'Use the usage logs view to inspect every request and its outcome.',
  'Unavailable',
  'Live',
  'Unable to load call statistics. Check log permissions and try again.',
  'calls recorded in the selected period',
  'Open usage logs',
  'Analytics notes',
  'Data source',
  'Gateway usage logs',
  'All accessible calls',
  'Search tagging',
  'Pending product=search',
  'Search-specific trend and spend views will appear when connector execution is enabled.',
  'AgentKey configuration',
  'Capability scopes',

  // Search workspace navigation and dynamic options
  'Access and keys',
  'Capability catalog',
  'Call logs',
  'Upstream accounts',
  ...
  'Back to vSearch',
  'Search administration navigation',
  'Not available',
  '24 Hours',
  '7 Days',
  '30 Days',
  '90 Days',
  'Declared vSearch capabilities',
  'These capability groups come from the current catalog definition. Runtime availability, connector health, and pricing are not exposed yet.',
  'Declared catalog',
  'Declared services',
  'Search capability catalog',
  'No declared services found. Try another search term or category.',
  'Use the key when search API is enabled',
  'The install command is short-lived and can be used once.',
  'Search execution is not enabled yet. Keep this secret private until the gateway endpoint is connected.',
  'Search-only log filter pending',
  'The current self log API returns all gateway calls for this user. Search-only filtering is not available yet.',
  'Token / AgentKey',
  'Filter by token or AgentKey',
  'Gateway call count',
  'Current page average latency',
  'Current page',
  'Gateway quota consumed',
  'Error code',
  'Indeterminate',
